            ...
            <div className="max-w-[1440px] mx-auto">
                ...
                <div className="flex flex-col md:flex-row items-end justify-between mb-12 md:mb-20 gap-8">
                    <div className="max-w-3xl">
                        <h2 className="text-4xl md:text-6xl font-display text-deep-black uppercase leading-[0.9] tracking-tighter mb-4 md:mb-8">
                            Tailored solutions <br />
                            <span className="text-brand-blue">for your branded</span> <br />
                            product initiatives
                        </h2>
                    </div>
                    ...
                    <div className="flex gap-4">
                        <Magnetic strength={0.5}>
                            <button
                                onClick={prevSlide}
                                className="w-12 h-12 md:w-16 md:h-16 rounded-full brutalist-border flex items-center justify-center hover:bg-brand-blue hover:text-white transition-colors group"
                            >
                                <span className="material-symbols-outlined text-2xl md:text-4xl group-active:-translate-x-1 transition-transform">arrow_back</span>
                            </button>
                        </Magnetic>
                        <Magnetic strength={0.5}>
                            <button
                                onClick={nextSlide}
                                className="w-12 h-12 md:w-16 md:h-16 rounded-full brutalist-border flex items-center justify-center hover:bg-brand-yellow transition-colors group"
                            >
                                <span className="material-symbols-outlined text-2xl md:text-4xl group-active:translate-x-1 transition-transform">arrow_forward</span>
                            </button>
                        </Magnetic>
                    </div>
                </div>

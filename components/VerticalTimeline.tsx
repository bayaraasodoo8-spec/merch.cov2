...
const VerticalTimeline: React.FC = () => {
    ...
    return (
        <div ref={containerRef} className="relative py-8 md:py-16 overflow-hidden bg-brand-yellow border-t-[1px] border-deep-black/10">
                ...
                {PROCESS_STEPS.map((step, index) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className={`relative flex flex-col md:flex-row items-center mb-12 md:mb-20 last:mb-0 ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'}`}
                        >
                            ...
                            <div className="w-full md:w-1/2 pl-12 md:pl-0 md:px-12 lg:px-24 group mt-8 md:mt-0">
                                <motion.div
                                    whileHover={{ y: -5 }}
                                    className="relative p-5 md:p-8 bg-white border-[1px] border-deep-black/10 shadow-xl transition-all duration-500"
                                >
                                    ...
                                    <p className="text-sm md:text-base font-body font-medium text-deep-black/60 leading-relaxed italic">
                                        "{step.description}"
                                    </p>
